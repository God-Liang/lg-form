<template>
  <el-form-item :label="widget.name" :prop="widget.model" :label-width="widget.type == 'title' ? '0px' : ''">
    ...
    <template v-if="widget.type == 'title'">
      <div
        :style="{textAlign: widget.options.alignment, fontSize: widget.options.fontSize + 'px',lineHeight: widget.options.fontSize + 10 + 'px'}"
        >{{widget.options.title}}</div>
    </template>
